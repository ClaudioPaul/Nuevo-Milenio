...
public class Padre {
    ...
    public Padre(int idPadre, String Nombre, String ApellidoP, String ApellidoM, int Dni, int Telefono, int TelefonoReferencia, String Correo, String dirección, int ValidarA, int ValidarP) {
